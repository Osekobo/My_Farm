...
Revision ID: e791172ebe9d
Revises: 
Create Date: 2025-09-26 14:53:27.520633
...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('egg_production_id', sa.Integer(), nullable=False),
    sa.Column('date', sa.Date(), nullable=False),
    ...
    sa.ForeignKeyConstraint(['egg_production_id'], ['egg_production.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
